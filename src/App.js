...
class App extends Component {
  ...
  render() {
    try {
      const { confirmed, deaths, recovered, date } = (this.state.locations.filter(location => location.country === this.state.location.country)).shift()
      return (
        <>
                  ...
                  <div className="row no-gutters">
                    <div className="col-12">
                      <div className="card-body">
                        ...
                        <p className="card-text"><span class="badge badge-warning">Cconfirmed</span>  : {confirmed || 0}</p>
                        <p className="card-text"><span class="badge badge-danger">Deaths</span> : {deaths || 0}</p>
                        <p className="card-text"><span class="badge badge-success">Recovered</span> : {recovered || 0}</p>
                      </div>
